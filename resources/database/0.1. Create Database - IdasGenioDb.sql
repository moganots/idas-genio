...
GO
PRINT ('>> Start > Execute Script > 0.1. Create Database - IdasGenioDb');
GO
...
-- Create the [dbo].[ConfigurationSetting] table
CREATE TABLE [dbo].[ConfigurationSetting](
	[_id] [bigint] IDENTITY(1,1) NOT NULL,
	[ConfigurationTypeId] [bigint] NOT NULL,
...
GO
PRINT ('>> Completed > Create > Table > [dbo].[ConfigurationSetting]')
GO
...
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------
-- Create all  DEFAULT constraints
-- *_IsAccepted
-- *_IsActive
-- *_IsAdmin
-- *_IsAllDayEvent
...
BEGIN
	...
	SET @ColumnDefaultValue = 
		CASE
			WHEN @ColumnName IN ('IsActive') THEN '1'
			WHEN @ColumnName IN (
				'IsAccepted',
				'IsAdmin',
				'IsAllDayEvent',
				...
				'IsTentative',
				'IsTerminated',
				'IsTransactionSuccessful') THEN '0'
			WHEN @ColumnName IN ('DateCreated') THEN 'GETDATE()'
		ELSE 'NULL' END;
...
PRINT ('>> Completed > Create > All > DEFAULT constraints');
GO
...
SELECT
	CASE
		...
		WHEN [LookupCategory] IN ('ConfigurationType') THEN 'CFGTYP'
...
SELECT 'CalendarEventType' AS [LookupCategory], 'Board' AS [Value], NULL AS [Image], 'leaderboard' AS [Icon], NULL AS [Color] UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'Database Connection String' AS [Value], NULL AS [Image], 'usb' AS [Icon], NULL AS [Color]  UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'SSL Certificate' AS [Value], NULL AS [Image], 'lens_blur' AS [Icon], NULL AS [Color]  UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'Path Directory' AS [Value], NULL AS [Image], 'create_new_folder' AS [Icon], NULL AS [Color]  UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'Account' AS [Value], NULL AS [Image], 'account_circle' AS [Icon], NULL AS [Color]  UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'Email' AS [Value], NULL AS [Image], 'mail_outline' AS [Icon], NULL AS [Color]  UNION
...
SELECT 'ConfigurationType' AS [LookupCategory], 'File Size' AS [Value], NULL AS [Image], 'memory' AS [Icon], NULL AS [Color]  UNION
SELECT 'ConfigurationType' AS [LookupCategory], 'Default Time Zone' AS [Value], NULL AS [Image], 'access_alarms' AS [Icon], NULL AS [Color]  UNION
...
PRINT ('>> Completed > INSERT >> Default >> [dbo].[ConfigurationSetting]')
GO
...
GO
PRINT ('>> Completed > Execute Script > 0.1. Create Database - IdasGenioDb');
GO
