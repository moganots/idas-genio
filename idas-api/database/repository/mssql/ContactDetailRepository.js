...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[ContactDetail] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `ContactDetail`;
const _ContactDetail = require(`./../../models/mssql/ContactDetail`);
 ...
 */
const Repository = () => {
    const ContactDetail = _ContactDetail();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = ContactDetail.fromEntity(request.body);
