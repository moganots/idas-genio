...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[Supplier] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
const _Supplier = require(`./../../models/mssql/Supplier`);
...
const Repository = () => {
    ...
    const create = (request, response, next) => {
        try{
            ...
            const entity = Supplier.fromEntity(request.body);
