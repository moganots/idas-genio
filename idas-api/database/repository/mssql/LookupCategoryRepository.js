...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[LookupCategory] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `LookupCategory`;
const _LookupCategory = require(`./../../models/mssql/LookupCategory`);
 ...
 */
const Repository = () => {
    const LookupCategory = _LookupCategory();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = LookupCategory.fromEntity(request.body);
