...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[EntityUserGroupCapacity] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `EntityUserGroupCapacity`;
const _EntityUserGroupCapacity = require(`./../../models/mssql/EntityUserGroupCapacity`);
 ...
 */
const Repository = () => {
    const EntityUserGroupCapacity = _EntityUserGroupCapacity();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = EntityUserGroupCapacity.fromEntity(request.body);
