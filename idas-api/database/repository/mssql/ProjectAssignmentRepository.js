...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[ProjectAssignment] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `ProjectAssignment`;
const _ProjectAssignment = require(`./../../models/mssql/ProjectAssignment`);
 ...
 */
const Repository = () => {
    const ProjectAssignment = _ProjectAssignment();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = ProjectAssignment.fromEntity(request.body);
