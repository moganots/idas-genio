...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[MenuItemUser] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `MenuItemUser`;
const _MenuItemUser = require(`./../../models/mssql/MenuItemUser`);
 ...
 */
const Repository = () => {
    const MenuItemUser = _MenuItemUser();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = MenuItemUser.fromEntity(request.body);
