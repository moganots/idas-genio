...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[EntityChangeHistory] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `EntityChangeHistory`;
const _EntityChangeHistory = require(`./../../models/mssql/EntityChangeHistory`);
 ...
 */
const Repository = () => {
    const EntityChangeHistory = _EntityChangeHistory();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = EntityChangeHistory.fromEntity(request.body);
