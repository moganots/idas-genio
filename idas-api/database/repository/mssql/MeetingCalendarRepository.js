...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[MeetingCalendar] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `MeetingCalendar`;
const _MeetingCalendar = require(`./../../models/mssql/MeetingCalendar`);
 ...
 */
const Repository = () => {
    const MeetingCalendar = _MeetingCalendar();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = MeetingCalendar.fromEntity(request.body);
