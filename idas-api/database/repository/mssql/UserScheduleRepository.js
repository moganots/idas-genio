...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[UserSchedule] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `UserSchedule`;
const _UserSchedule = require(`./../../models/mssql/UserSchedule`);
 ...
 */
const Repository = () => {
    const UserSchedule = _UserSchedule();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = UserSchedule.fromEntity(request.body);
