...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[ProjectReview] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `ProjectReview`;
const _ProjectReview = require(`./../../models/mssql/ProjectReview`);
 ...
 */
const Repository = () => {
    const ProjectReview = _ProjectReview();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = ProjectReview.fromEntity(request.body);
