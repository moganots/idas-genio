...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[CalendarEvent] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `CalendarEvent`;
const _CalendarEvent = require(`./../../models/mssql/CalendarEvent`);
 ...
 */
const Repository = () => {
    const CalendarEvent = _CalendarEvent();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = CalendarEvent.fromEntity(request.body);
