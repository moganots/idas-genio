...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[TaskAssignment] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `TaskAssignment`;
const _TaskAssignment = require(`./../../models/mssql/TaskAssignment`);
 ...
 */
const Repository = () => {
    const TaskAssignment = _TaskAssignment();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = TaskAssignment.fromEntity(request.body);
