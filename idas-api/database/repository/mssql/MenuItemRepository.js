...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[MenuItem] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `MenuItem`;
const _MenuItem = require(`./../../models/mssql/MenuItem`);
...
const Repository = () => {
    ...
    const create = (request, response, next) => {
        try{
            ...
            const entity = MenuItem.fromEntity(request.body);
