...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[EmployeeSalary] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `EmployeeSalary`;
const _EmployeeSalary = require(`./../../models/mssql/EmployeeSalary`);
 ...
 */
const Repository = () => {
    const EmployeeSalary = _EmployeeSalary();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = EmployeeSalary.fromEntity(request.body);
