...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[UserTypeMenuItem] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `UserTypeMenuItem`;
const _UserTypeMenuItem = require(`./../../models/mssql/UserTypeMenuItem`);
 ...
 */
const Repository = () => {
    const UserTypeMenuItem = _UserTypeMenuItem();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = UserTypeMenuItem.fromEntity(request.body);
