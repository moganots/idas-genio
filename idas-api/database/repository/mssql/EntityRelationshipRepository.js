...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[EntityRelationship] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `EntityRelationship`;
const _EntityRelationship = require(`./../../models/mssql/EntityRelationship`);
 ...
 */
const Repository = () => {
    const EntityRelationship = _EntityRelationship();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = EntityRelationship.fromEntity(request.body);
