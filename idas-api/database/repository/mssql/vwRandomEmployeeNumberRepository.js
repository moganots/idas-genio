...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[vwRandomEmployeeNumber] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `vwRandomEmployeeNumber`;
const _vwRandomEmployeeNumber = require(`./../../models/mssql/vwRandomEmployeeNumber`);
 ...
 */
const Repository = () => {
    const vwRandomEmployeeNumber = _vwRandomEmployeeNumber();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = vwRandomEmployeeNumber.fromEntity(request.body);
