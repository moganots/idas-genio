...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[Client] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
const _Client = require(`./../../models/mssql/Client`);
...
const Repository = () => {
    ...
    const create = (request, response, next) => {
        try{
            ...
            const entity = Client.fromEntity(request.body);
