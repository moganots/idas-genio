...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[NotificationMessage] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `NotificationMessage`;
const _NotificationMessage = require(`./../../models/mssql/NotificationMessage`);
 ...
 */
const Repository = () => {
    const NotificationMessage = _NotificationMessage();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = NotificationMessage.fromEntity(request.body);
