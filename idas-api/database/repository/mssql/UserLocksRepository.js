...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[UserLocks] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `UserLocks`;
const _UserLocks = require(`./../../models/mssql/UserLocks`);
 ...
 */
const Repository = () => {
    const UserLocks = _UserLocks();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = UserLocks.fromEntity(request.body);
