...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[Schedule] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
const _Schedule = require(`./../../models/mssql/Schedule`);
...
const Repository = () => {
    ...
    const create = (request, response, next) => {
        try{
            ...
            const entity = Schedule.fromEntity(request.body);
