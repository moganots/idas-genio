...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[GroupMenuItem] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `GroupMenuItem`;
const _GroupMenuItem = require(`./../../models/mssql/GroupMenuItem`);
 ...
 */
const Repository = () => {
    const GroupMenuItem = _GroupMenuItem();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = GroupMenuItem.fromEntity(request.body);
