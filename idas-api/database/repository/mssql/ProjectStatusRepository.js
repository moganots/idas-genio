...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[ProjectStatus] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `ProjectStatus`;
const _ProjectStatus = require(`./../../models/mssql/ProjectStatus`);
...
const Repository = () => {
    ...
    const create = (request, response, next) => {
        try{
            ...
            const entity = ProjectStatus.fromEntity(request.body);
