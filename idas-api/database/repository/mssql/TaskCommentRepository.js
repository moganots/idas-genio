...
| Description:	IDAS - Genio - API - MS SQL Entity (Model) Repository utility class for the [dbo].[TaskComment] Table
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
...
|--------------------------------------------------------------------------------------------------------------------------------------------
 */
const entityName = `TaskComment`;
const _TaskComment = require(`./../../models/mssql/TaskComment`);
 ...
 */
const Repository = () => {
    const TaskComment = _TaskComment();
    const dbContext = _dbContext();
    const create = (request, response, next) => {
        try{
            const uid = request.query.uid;
            const entity = TaskComment.fromEntity(request.body);
