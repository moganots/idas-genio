...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[ContactDetail] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/ContactDetailRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `contact-detail`;
