...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[ProjectStatus] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/ProjectStatusRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `project-status`;
