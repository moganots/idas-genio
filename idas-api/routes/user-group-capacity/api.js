...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[UserGroupCapacity] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/UserGroupCapacityRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `user-group-capacity`;
