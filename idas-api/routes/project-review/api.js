...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[ProjectReview] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/ProjectReviewRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `project-review`;
