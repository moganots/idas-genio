...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[MenuItemUser] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/MenuItemUserRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `menu-item-user`;
