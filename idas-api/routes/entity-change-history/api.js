...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[EntityChangeHistory] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/EntityChangeHistoryRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `entity-change-history`;
