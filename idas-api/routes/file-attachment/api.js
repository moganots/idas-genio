...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[FileAttachment] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/FileAttachmentRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `file-attachment`;
