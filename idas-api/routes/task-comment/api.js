...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[TaskComment] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/TaskCommentRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `task-comment`;
