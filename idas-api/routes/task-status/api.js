...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[TaskStatus] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/TaskStatusRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `task-status`;
