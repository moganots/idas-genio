...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[TaskAssignment] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/TaskAssignmentRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `task-assignment`;
