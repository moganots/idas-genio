...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[MeetingCalendar] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/MeetingCalendarRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `meeting-calendar`;
