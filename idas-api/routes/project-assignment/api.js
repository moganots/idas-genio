...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[ProjectAssignment] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/ProjectAssignmentRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `project-assignment`;
