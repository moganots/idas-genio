...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[EmployeeSalary] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/EmployeeSalaryRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `employee-salary`;
