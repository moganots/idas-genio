...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[ProjectComment] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/ProjectCommentRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `project-comment`;
