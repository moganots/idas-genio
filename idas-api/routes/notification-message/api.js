...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[NotificationMessage] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/NotificationMessageRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `notification-message`;
