...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[EntityRelationship] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/EntityRelationshipRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `entity-relationship`;
