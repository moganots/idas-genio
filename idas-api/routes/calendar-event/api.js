...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[CalendarEvent] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/CalendarEventRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `calendar-event`;
