...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[UserSchedule] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/UserScheduleRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `user-schedule`;
