...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[LookupCategory] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/LookupCategoryRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `lookup-category`;
