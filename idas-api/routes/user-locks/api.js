...
| Description:  IDAS - Genio - API - Routes utility class for the [dbo].[UserLocks] table
|------------------------------------------------------------------------------------------------------------------
 */
...
const _repository = require(`./../../database/repository/mssql/UserLocksRepository`);
...
module.exports = function(router, config) {
  const apiAnchorName = `user-locks`;
